<?php
/**
 *radios Bootstrap Navwalker
 *
 * @packageradios-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Radios_Bootstrap_Navwalker' ) ) {
	/**
	 * Radios_Bootstrap_Navwalker class.
	 */
	class Radios_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'radios' ) . '">' . esc_html__( 'Add a menu', 'radios' ) . '</a></li>';
			$fallback_output .= '</ul>';
